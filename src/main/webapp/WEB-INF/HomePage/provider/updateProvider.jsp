        ...
        <div class="providerAdd">
            <form id="providerForm" name="providerForm" method="post" action="${ctx}/provider/provider_add">
                ...
                <div class="">
                    ...
                    <input type="text" name="procode" id="proCode" value="${providerAll.procode}" datatype="*6-15" nullmsg="请填入数据"> 
					<!-- 放置提示信息 -->
					<font color="red" style="color: rgb(102, 102, 102);">* 请输入供应商编码</font>
                </div>
                <div>
                    <label for="proName">供应商名称：</label>
                   <input type="text" name="proname" id="proName" value="${providerAll.proname}" datatype="*6-15" nullmsg="请填入数据"> 
					<font color="red">*</font>
                </div>
                <div>
                    <label for="proContact">联系人：</label>
                    <input type="text" name="procontact" id="proContact" value="${providerAll.procontact}" datatype="s1-8" nullmsg="请填入数据"> 
					<font color="red">*</font>

                </div>
                <div>
                    <label for="proPhone">联系电话：</label>
                    <input type="text" name="prophone" id="proPhone" value="${providerAll.prophone}" datatype="m" nullmsg="请填入信息"> 
					<font color="red">*</font>
                </div>
                <div>
                    <label for="proAddress">联系地址：</label>
                    <input type="text" name="proaddress" id="proAddress" value="${providerAll.proaddress}" datatype="s1-8" nullmsg="请填入数据"> 
                </div>
                <div>
                    <label for="proFax">传真：</label>
                    <input type="text" name="profax" id="proFax" value="${providerAll.profax}" nullmsg="请填入数据"> 
                </div>
                <div>
                    <label for="proDesc">描述：</label>
                    <input type="text" name="prodesc" id="proDesc" value="${providerAll.prodesc}" nullmsg="请填入数据"> 
                </div>
